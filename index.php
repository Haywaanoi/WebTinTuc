...
<body>
	...
	<div class="site-main-container">
		...
		if (isset($_GET['id_nhomtin'])) {
			...
			$sql = "SELECT * FROM tin_tuc join loai_tin on tin_tuc.id_loaitin = loai_tin.id_loaitin Where id_nhomtin=:id_nhomtin or tin_tuc.id_loaitin=:id_nhomtin order by datetime LIMIT :limit";
		?>
			<!-- START HOT POST -->
			<?php
